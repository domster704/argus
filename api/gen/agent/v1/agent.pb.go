...
func (x *PushSnapshotRequest) GetAgentId() string {
	if x != nil {
		return x.AgentId
	}
	return ""
...
func (x *PushSnapshotRequest) GetHostname() string {
	if x != nil {
		return x.Hostname
	}
	return ""
...
func (x *PushSnapshotRequest) GetSnapshot() *Snapshot {
	if x != nil {
		return x.Snapshot
	}
	return nil
...
const file_agent_agent_proto_rawDesc = "" +
	"\n" +
	"\x11agent/agent.proto\x12\x0eargus.agent.v1\x1a\x15agent/telemetry.proto\"\x82\x01\n" +
	"\x13PushSnapshotRequest\x12\x19\n" +
	"\bagent_id\x18\x01 \x01(\tR\aagentId\x12\x1a\n" +
	"\bhostname\x18\x02 \x01(\tR\bhostname\x124\n" +
	"\bsnapshot\x18\x03 \x01(\v2\x18.argus.agent.v1.SnapshotR\bsnapshot\"\x16\n" +
	"\x14PushSnapshotResponse2r\n" +
	"\x15AgentTelemetryService\x12Y\n" +
	"\fPushSnapshot\x12#.argus.agent.v1.PushSnapshotRequest\x1a$.argus.agent.v1.PushSnapshotResponseB7Z5github.com/domster704/argus/api/gen/agent/v1;agent_v1b\x06proto3"
...
var file_agent_agent_proto_goTypes = []any{
	(*PushSnapshotRequest)(nil),  // 0: argus.agent.v1.PushSnapshotRequest
	(*PushSnapshotResponse)(nil), // 1: argus.agent.v1.PushSnapshotResponse
	(*Snapshot)(nil),             // 2: argus.agent.v1.Snapshot
}
var file_agent_agent_proto_depIdxs = []int32{
	2, // 0: argus.agent.v1.PushSnapshotRequest.snapshot:type_name -> argus.agent.v1.Snapshot
	0, // 1: argus.agent.v1.AgentTelemetryService.PushSnapshot:input_type -> argus.agent.v1.PushSnapshotRequest
	1, // 2: argus.agent.v1.AgentTelemetryService.PushSnapshot:output_type -> argus.agent.v1.PushSnapshotResponse
...
func file_agent_agent_proto_init() {
	...
	file_agent_telemetry_proto_init()
	type x struct{}
